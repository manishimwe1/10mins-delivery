...
export default function CheckoutPage() {
  ...
  const cartItems = [
    { id: 1, name: "Fresh Bananas", price: 2.99, quantity: 2 },
    { id: 2, name: "Whole Milk", price: 3.49, quantity: 1 },
    { id: 3, name: "Bread Loaf", price: 2.79, quantity: 1 },
  ]
  ...
  const handlePaymentComplete = (paymentId: string) => {
    ...
    if (currentOrderId) {
      router.push(`/customer/order-confirmation?orderId=${currentOrderId}&paymentId=${paymentId}`)
    }
  }
                  ...
                  <div className="flex items-center space-x-2 p-4 border border-border/40 rounded-lg">
                    ...
                    <Label htmlFor="mobile_money" className="flex items-center gap-2 cursor-pointer flex-1">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Pay via MTN, Airtel, or Vodafone</div>
                      </div>
                    </Label>
                  </div>
                </RadioGroup>
